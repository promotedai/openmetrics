...
printf "Deleting Flink ContentQueryMetricsJob..."
kubectl delete -k kubernetes/_envs/prm/content-query-metrics/local/blue
printf "Done!\n"

printf "Deleting Flink ContentQueryMetricsJob jobs..."
...
delete_flink_job content-query-metrics || true
