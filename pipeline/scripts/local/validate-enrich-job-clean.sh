...
printf "Deleting Flink ValidateEnrichJob..."
kubectl delete -k kubernetes/_envs/prm/validate-enrich/local/blue
printf "Done!\n"

printf "Deleting Flink ValidateEnrichJob jobs..."
...
delete_flink_job validate-enrich || true
