 ...
 *
 * <p>This {@code Content} does not map 1:1 to Content in the Content Store.
 * This {@code Content} represents the whole entity for fake data generation.
 * It represents both the Content fields passed on the Request and Content fields
 * retrieved through DocumentDB Content Store.
 * </p>
 */
@AutoValue
