...
/**
 * Copies {@link LogRequest}'s {@link Session} and fills in default base values.
...
public class PushDownAndFlatMapSession extends BasePushDownAndFlatMap<Session> {
    ...
    private static Session pushDownFields(Session session, LogRequest batchValue, String lowerCaseBatchLogUserId) {
