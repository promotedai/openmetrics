...
/**
 * Copies {@link LogRequest}'s {@link Impression} and fills in default base values.
...
public class PushDownAndFlatMapImpression extends BasePushDownAndFlatMap<Impression> {
    ...
    public static Impression pushDownFields(Impression impression, LogRequest batchValue, String lowerCaseBatchLogUserId) {
