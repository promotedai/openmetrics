...
/**
 * A {@code BoundedOutOfOrdernessWatermarks} but meant for local development.
 * During local development (for now), we want to increase the watermark more frequently to output events.
 *
 * This file was copied and forked from {@code BoundedOutOfOrdernessWatermarks}.
 */
public class LocalProcAndEventBoundedOutOfOrdernessWatermarkGenerator<T> implements WatermarkGenerator<T> {
    private static final Logger LOGGER = LogManager.getLogger(LocalProcAndEventBoundedOutOfOrdernessWatermarkGenerator.class);
    ...
    public void onPeriodicEmit(WatermarkOutput output) {
        ...
        if (potentialWM > lastEmittedWatermark) {
            ...
            if (potentialWM == lastEmittedWatermark && nEventsWithSameTimestamp != lastNEventsWithSameTimestamp) {
        ...
        LOGGER.trace("emitting instance: {} watermark: {}", System.identityHashCode(this), lastEmittedWatermark);
