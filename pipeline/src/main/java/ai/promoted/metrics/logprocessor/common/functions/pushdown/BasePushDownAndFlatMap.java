...
/**
 * Copies a specific sub-log from {@link LogRequest} and fills in missing sub-log values from {@link LogRequest} values.
 * <p>
...
public abstract class BasePushDownAndFlatMap<T> implements FlatMapFunction<LogRequest, T> {
    ...
    static void pushDownLogUserIdFields(UserInfo.Builder userInfoBuilder, String lowerCaseBatchLogUserId) {
