...
public class PlatformUserContentEvent extends Tuple4<Long, String, String, String>
    implements UserEventRedisHashSupplier {
  public static final String NAME = "plat-usr-cont_$evt";
  public static final String DEPRECATED_NAME = "last-time-user-event";

  public PlatformUserContentEvent() {}

  public PlatformUserContentEvent(
      Long platformId, String user, String contendId, String aggMetric) {
