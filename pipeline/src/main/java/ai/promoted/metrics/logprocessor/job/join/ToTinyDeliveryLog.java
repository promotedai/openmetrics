...
final class ToTinyDeliveryLog implements MapFunction<CombinedDeliveryLog, TinyDeliveryLog> {
    ...
    public TinyDeliveryLog map(CombinedDeliveryLog combinedDeliveryLog) {
        ...
        TinyDeliveryLog.Builder builder = TinyDeliveryLog.newBuilder()
        ...
        if (otherContentIdsConverter.hasKeys()) {
            ...
            if (request.hasProperties()) {
                otherContentIdsConverter.putFromProperties(requestOtherContentIds::put, request.getProperties());
            }
        } else {
        ...
        deliveryLog.getResponse().getInsertionList()
                .stream().forEach(responseInsertion -> {
                    TinyDeliveryLog.TinyInsertion.Builder tinyInsertion = builder.addResponseInsertionBuilder()
                    ...
                    if (otherContentIdsConverter.hasKeys()) {
                        ...
                        Insertion requestInsertion = contentIdToRequestInsertion.get(responseInsertion.getContentId());
    ...
    private void addOtherContentIdsFromProperties(
        ...
        otherContentIdsConverter.putFromProperties(tinyInsertion::putOtherContentIds, requestInsertion.getProperties());
    }
        ...
        return request.getInsertionList().stream()
                .collect(Collectors.toMap(
                        ...
                        (insertion1, insertion2) -> {
                            ...
                            LOGGER.error("Multiple request insertions with the same contentId, {}, found on Request={}", insertion1.getContentId(), request);
