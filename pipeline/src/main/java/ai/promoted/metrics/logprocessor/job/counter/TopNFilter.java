...
public class TopNFilter<B, K, V> extends KeyedBroadcastProcessFunction<K, V, Tuple2<B, Boolean>, V> {
    ...
    public void open(Configuration config) {
        delayedInput = getRuntimeContext().getListState(new ListStateDescriptor<>("delayed-input", valueTypeInfo));
    }
    ...
    public void processElement(
            ...
            Collector<V> out) throws Exception {
