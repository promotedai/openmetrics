...
/**
 * Copies {@link LogRequest}'s {@link DeliveryLog} and fills in default base values.
...
public class PushDownAndFlatMapDeliveryLog extends BasePushDownAndFlatMap<DeliveryLog> {
    ...
    public static DeliveryLog pushDownFields(DeliveryLog deliveryLog, LogRequest batchValue, String lowerCaseBatchLogUserId) {
