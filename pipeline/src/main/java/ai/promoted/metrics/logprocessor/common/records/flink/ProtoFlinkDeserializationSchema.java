...
import ai.promoted.metrics.logprocessor.common.records.ProtoDeserializer;
...
/**
 * A Kafka {@link DeserializationSchema} to deserialize Protocol Buffers. Copy code to avoid a weird
 * Flink serialization error.
 */
public class ProtoFlinkDeserializationSchema<T extends GeneratedMessageV3>
  ...
  public ProtoFlinkDeserializationSchema(Class<T> clazz, ProtoDeserializer<T> deserializer) {
    this.clazz = clazz;
