...
public abstract class JoinValueSetterOptions {
    ...
    // We use this type so we can directly pass around the Context's instance method and not have to wrap it.
    ...
    public abstract static class Builder {
        ...
        public abstract JoinValueSetterOptions.Builder setLogFunctionName(LogFunctionName logFunctionName);
        public abstract JoinValueSetterOptions.Builder setErrorLogger(BiConsumer<OutputTag<MismatchError>, MismatchError> errorLogger);
