...
public final class StringUtil {
     ...
     *
     * This is not compatible with our go-hashlib or java hashCode implementation.
    ...
    /**
     * Returns a hash for {@code value}.  This method has a test to make sure the hashcode impl doesn't change out
     * from under us in future Java versions.  This is not the same hashing used for our Feature ID hashing.
     */
