...
public final class ContentAPILoaderImpl implements ContentAPILoader {
    ...
    public ContentAPILoaderImpl(
        ...
        this(new HttpClientImpl(rootContentApiUrl, apiKey),
                defaultMaxAttempts,
    ...
    public Map<String, Map<String, Object>> apply(Collection<String> contentIds) {
        ...
        while (true) {
            ...
            if (statusCode == 200) {
                // TODO - Implement a custom deserializer so we don't need to add create a map of all properties.
        ...
        if (consecutiveErrors > maxAllowedConsecutiveErrors) {
            ...
            LOGGER.error("Content API retries failed for contentIds={}.  Has consecutive error limit={}/{}, statusCode={}, error={}",
                    contentIds, consecutiveErrors, maxAllowedConsecutiveErrors, statusCode, error);
            return ImmutableMap.of();
        }
    }
    ...
    private static class HttpClientImpl implements HttpClientInterface {
        ...
        @Override
        public HttpResponse send(Collection<String> contentIds) throws IOException, InterruptedException {
            if (httpClient == null) {
