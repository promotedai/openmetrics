...
/**
 * FixedProtobufData helps us change our Avro schemas to work with AWS Glue because Glue does not
...
public class FixedProtobufData extends PromotedProtobufData {
  ...
  private final List<String> qualityScoreTermsUnionedFullNames =
      getUnionedFullNames("ai.promoted.proto.delivery.QualityScoreTerms%d", 5);
  private final List<String> qualityScoreTermUnionedFullNames =
      getUnionedFullNames("ai.promoted.proto.delivery.QualityScoreTerm%d", 5);
