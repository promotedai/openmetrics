...
public interface JoinedImpressionTable {
    TypeInformation<Row> ROW_TYPE_INFORMATION = Types.ROW_NAMED(
            new String[]{"platform_id", "event_api_timestamp", "impression_id", "content_id", "position"},
            Types.LONG, Types.LOCAL_DATE_TIME, Types.STRING, Types.STRING, Types.LONG);
