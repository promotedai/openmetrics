...
public interface FlinkSegment {
    ...
    /** Make sure the command line args are valid.
     * Log/throw whatever you need to here for any cli argument consistency you need.
     * IMPORTANT: call all ancestor and interface validateArgs to ensure correct behavior.
     */
    ...
    static <T extends GeneratedMessageV3> void optionalRegisterProtobufSerializer(ExecutionConfig config, Class<T> clazz) {
        if (clazz != null) {
