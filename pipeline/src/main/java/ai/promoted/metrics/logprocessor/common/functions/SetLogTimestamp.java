...
public class SetLogTimestamp<T, B> extends ProcessFunction<T, T> {
    ...
    public SetLogTimestamp(SerializableFunction<T, B> toBuilder,
    ...
    public static final SetLogTimestamp<AutoView, AutoView.Builder> forAutoView =
        new SetLogTimestamp<>(AutoView::toBuilder, AutoView.Builder::getTimingBuilder, AutoView.Builder::build);
    ...
    public static final SetLogTimestamp<Request, Request.Builder> forRequest =
        new SetLogTimestamp<>(Request::toBuilder, Request.Builder::getTimingBuilder, Request.Builder::build);

    public static final SetLogTimestamp<Impression, Impression.Builder> forImpression =
        new SetLogTimestamp<>(Impression::toBuilder, Impression.Builder::getTimingBuilder, Impression.Builder::build);

    public static final SetLogTimestamp<Action, Action.Builder> forAction =
        new SetLogTimestamp<>(Action::toBuilder, Action.Builder::getTimingBuilder, Action.Builder::build);
