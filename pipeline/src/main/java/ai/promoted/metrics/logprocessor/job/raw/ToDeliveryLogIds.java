...
class ToDeliveryLogIds implements MapFunction<DeliveryLog, DeliveryLogIds> {
    ...
    @VisibleForTesting
    static EnumMap<ExecutionServer, ai.promoted.metrics.common.ExecutionServer> protoToAvroServer = createAvroExecutionServer();
    ...
    private static EnumMap<ExecutionServer, ai.promoted.metrics.common.ExecutionServer> createAvroExecutionServer() {
        EnumMap<ExecutionServer, ai.promoted.metrics.common.ExecutionServer> map = new EnumMap(ExecutionServer.class);
