...
public class UserInfoUtil {
    ...
    public static final FlatResponseInsertion.Builder clearUserId(FlatResponseInsertion.Builder builder) {
        if (builder.hasIds()) {
            builder.getIdsBuilder().clearUserId();
        }
        if (builder.hasUser()) {
    ...
    public static final DroppedMergeDetailsEvent.Builder clearUserId(DroppedMergeDetailsEvent.Builder builder) {
