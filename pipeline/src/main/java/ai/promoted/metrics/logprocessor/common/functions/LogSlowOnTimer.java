...
public class LogSlowOnTimer<K, IN1, IN2, OUT> extends KeyedCoProcessFunction<K, IN1, IN2, OUT> {
  ...
  public void processElement1(
      IN1 var1, KeyedCoProcessFunction<K, IN1, IN2, OUT>.Context var2, Collector<OUT> var3)
      throws Exception {
  ...
  public void processElement2(
      IN2 var1, KeyedCoProcessFunction<K, IN1, IN2, OUT>.Context var2, Collector<OUT> var3)
      throws Exception {
  ...
  public void onTimer(
    ...
    if (duration.compareTo(ON_TIMER_SLOW_THRESHOLD) > 0) {
      LOGGER.warn(
          "{} is slower ({}) than expected ({}).", delegate, duration, ON_TIMER_SLOW_THRESHOLD);
    }
  }
