...
/**
 * Pulls other content IDs from Properties. Other content IDs are foreign keys that are used when
 * handling hierarchical content joins.
 */
final class OtherContentIdsConverter implements Serializable {
  ...
  void putFromProperties(BiConsumer<Integer, String> putOtherContentIds, Properties properties) {
