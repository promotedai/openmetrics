...
public interface ActionTable {
    TypeInformation<Row> ACTION_ROW = Types.ROW_NAMED(
            new String[]{"platform_id", "event_api_timestamp", "action_id", "impression_id", "insertion_id", "content_id", "action_type"},
            Types.LONG, Types.LOCAL_DATE_TIME, Types.STRING, Types.STRING, Types.STRING, Types.STRING, Types.INT);
    Schema ACTION_SCHEMA = Schema.newBuilder()
    ...
    TypeInformation<Row> ACTION_CART_CONTENT_ROW = Types.ROW_NAMED(
            new String[]{"platform_id", "event_api_timestamp", "action_id", "impression_id", "insertion_id",
                    "content_id", "action_type", "quantity", "price_usd_micros_per_unit"},
            Types.LONG, Types.LOCAL_DATE_TIME, Types.STRING, Types.STRING, Types.STRING,
                    Types.STRING, Types.INT, Types.LONG, Types.LONG);

    Schema ACTION_CART_CONTENT_SCHEMA = Schema.newBuilder()
            .columnByMetadata("rowtime", DataTypes.TIMESTAMP_WITH_LOCAL_TIME_ZONE(3), "rowtime")
            .watermark("rowtime", "SOURCE_WATERMARK()")
            .build();
