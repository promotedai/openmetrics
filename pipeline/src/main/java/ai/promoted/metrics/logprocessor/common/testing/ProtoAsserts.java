...
/** Proto Avro asserts. Proto or Pojo specific asserts should go into other assert files. */
public class ProtoAsserts {

  public static void assertNoUnknownRecursiveTypes(
      Descriptors.Descriptor descriptor, Set<String> okayNestedTypes) {
  ...
  private static void assertNoUnknownRecursiveTypes(
      Descriptors.Descriptor descriptor,
      Set<String> okayNestedTypes,
      Set<String> alreadyTraversedTypes) {
    ...
    for (Descriptors.FieldDescriptor fieldDescriptor : descriptor.getFields()) {
      switch (fieldDescriptor.getType()) {
        case MESSAGE:
          assertNoUnknownRecursiveTypes(
              fieldDescriptor.getMessageType(), okayNestedTypes, alreadyTraversedTypes);
          break;
      }
    }
  }
