...
public class PromotedPbCodegenSerializeFactory {
  public static PbCodegenSerializer getPbCodegenSer(
    ...
    if (type instanceof RowType) {
      return new PromotedPbCodegenRowSerializer(fd.getMessageType(), (RowType) type, formatContext);
    } else if (PromotedPbFormatUtils.isSimpleType(type)) {
      return new PbCodegenSimpleSerializer(fd, type, formatContext);
    } else if (type instanceof ArrayType) {
      return new PromotedPbCodegenArraySerializer(
  ...
  public static PbCodegenSerializer getPbCodegenTopRowSer(
    ...
    return new PromotedPbCodegenRowSerializer(descriptor, rowType, formatContext);
  }
}
