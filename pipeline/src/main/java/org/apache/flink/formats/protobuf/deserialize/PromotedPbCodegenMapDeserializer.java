 ...
 *
 * <p>Copied from
 * https://github.com/apache/flink/blob/cc94a1d1855af3523ed117e6cbab8999b231c822/flink-formats/flink-protobuf/src/main/java/org/apache/flink/formats/protobuf/deserialize/PbCodegenMapDeserializer.java
 */
public class PromotedPbCodegenMapDeserializer implements PbCodegenDeserializer {
  private final Descriptors.FieldDescriptor fd;
  private final MapType mapType;
  private final PbFormatContext formatContext;

  public PromotedPbCodegenMapDeserializer(
  ...
  public String codegen(String resultVar, String pbObjectCode, int indent)
    ...
    PbCodegenDeserializer keyDes =
        PromotedPbCodegenDeserializeFactory.getPbCodegenDes(keyFd, keyType, formatContext);
    PbCodegenDeserializer valueDes =
        PromotedPbCodegenDeserializeFactory.getPbCodegenDes(valueFd, valueType, formatContext);
    // Change ends
    String keyGenCode =
        keyDes.codegen(
            flinkKeyVar,
