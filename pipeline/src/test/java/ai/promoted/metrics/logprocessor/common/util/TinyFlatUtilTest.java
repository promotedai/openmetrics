...
public class TinyFlatUtilTest {
  ...
  public void mergeTinyEvent_mergeImpression_noTimestamp() {
    TinyEvent.Builder builder =
        TinyFlatUtil.mergeImpression(
            ...
            TinyEvent.newBuilder().setImpressionId("impression1").build(),
            noopErrorLogger);
    ...
    TinyEvent.Builder builder =
        TinyFlatUtil.mergeImpression(
            TinyEvent.newBuilder()
                ...
                .setContentId("content1")
                .setLogTimestamp(1L),
            TinyEvent.newBuilder().setImpressionId("impression1").setLogTimestamp(2L).build(),
            noopErrorLogger);
    ...
    TinyEvent.Builder builder =
        TinyFlatUtil.mergeAction(
            TinyEvent.newBuilder()
                ...
                .setContentId("content1")
                .setImpressionId("impression1"),
            TinyEvent.newBuilder().setActionId("action1").build(),
            noopErrorLogger);
    ...
    TinyEvent.Builder builder =
        TinyFlatUtil.mergeAction(
            TinyEvent.newBuilder()
                ...
                .setImpressionId("impression1")
                .setLogTimestamp(1L),
            TinyEvent.newBuilder().setActionId("action1").setLogTimestamp(2L).build(),
            noopErrorLogger);
  ...
  public void createTinyFlatResponseInsertions_withoutTimestamps() {
    List<TinyEvent.Builder> builders =
        TinyFlatUtil.createTinyFlatResponseInsertions(
            TinyEvent.newBuilder().setPlatformId(1L).setLogUserId("logUser1").setViewId("view1"),
