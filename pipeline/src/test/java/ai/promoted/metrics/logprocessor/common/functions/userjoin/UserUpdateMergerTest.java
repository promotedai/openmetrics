...
public class UserUpdateMergerTest {
    ...
    public void multipleUserUpdates() {
        ...
        User userUpdate3 = createUserBuilder(30L)
                ...
                .build();
        User userUpdate4 = createUserBuilder(40L)
                .setUserInfo(UserInfo.newBuilder().setLogUserId("logUserId1"))
                .build();
        UserUpdateMerger builder = new UserUpdateMerger(ImmutableList.of(userUpdate1, userUpdate2, userUpdate3, userUpdate4), true);

        assertThat(builder.getEffectiveUser()).isNull();
        assertThat(builder.getRemainingUserUpdatesCount()).isEqualTo(4);
        assertThat(builder.getRemainingUserUpdates()).containsExactly(userUpdate1, userUpdate2, userUpdate3, userUpdate4);
        ...
        assertThat(builder.getRemainingUserUpdates()).containsExactly(userUpdate2, userUpdate3, userUpdate4);
        ...
        assertThat(builder.getEffectiveUser()).isEqualTo(
                createUserBuilder(30L)
                        .setUserInfo(UserInfo.newBuilder().setLogUserId("logUserId1").setIsInternalUser(true).setIgnoreUsage(true))
                        .setProperties(Properties.newBuilder()
                                .setStruct(Struct.newBuilder()
                                        .putFields("key2", Value.newBuilder().setNumberValue(2).build())))
                        .build());
    ...
    public void assertSameLogUserId() {
        User userUpdate1 = createUser(10L).toBuilder()
                .setUserInfo(UserInfo.newBuilder().setLogUserId("logUserId1"))
                .build();
        User userUpdate2 = createUser(20L).toBuilder()
                .setUserInfo(UserInfo.newBuilder().setLogUserId("logUserId2"))
                .build();
        UserUpdateMerger builder = new UserUpdateMerger(ImmutableList.of(userUpdate1, userUpdate2), true);
