  ...
  public void pushDownAllFieldsTest() throws Exception {
    assertEquals(
        LogRequest.newBuilder()
            ...
            .setUserInfo(UserInfo.newBuilder().setUserId(USER_ID).setLogUserId(LOG_USER_ID))
        ...
        new PushDownBatchFields()
            .map(
                LogRequest.newBuilder()
                    ...
                    .addSession(Session.newBuilder().setSessionId(SESSION_ID))
                    .addSessionProfile(SessionProfile.newBuilder().setSessionId(SESSION_ID))
                    .addView(View.newBuilder().setViewId(VIEW_ID).setSessionId(SESSION_ID))
                    .addRequest(Request.newBuilder().setRequestId(REQUEST_ID).setViewId(VIEW_ID))
                    .addInsertion(
                        Insertion.newBuilder()
                            .setInsertionId(INSERTION_ID)
                            .setRequestId(REQUEST_ID))
                    .addImpression(
                        Impression.newBuilder()
                            ...
                            .setImpressionId(IMPRESSION_ID))
                    .addAction(
                        Action.newBuilder().setImpressionId(IMPRESSION_ID).setActionId(ACTION_ID))
                    .build()));
  }
                ...
                LogRequest.newBuilder()
                    ...
                    .addUser(
                        User.newBuilder()
                            .setPlatformId(PLATFORM_ID)
                            .setUserInfo(
                                UserInfo.newBuilder().setUserId(USER_ID).setLogUserId(LOG_USER_ID))
                            .setTiming(createTiming(TIME_EPOCH_MILLIS)))
                    .addSessionProfile(
                        SessionProfile.newBuilder()
                            .setPlatformId(PLATFORM_ID)
                ...
                LogRequest.newBuilder()
                    ...
                    .addSession(
                        Session.newBuilder()
                            .setPlatformId(PLATFORM_ID)
                            .setUserInfo(
                                UserInfo.newBuilder().setLogUserId(CAMEL_CASED_LOG_USER_ID))
                            .setTiming(createTiming(TIME_EPOCH_MILLIS))
                            .setSessionId(SESSION_ID))
                    .addView(
                        View.newBuilder()
