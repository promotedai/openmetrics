        ...
        DeliveryLog.newBuilder()
            ...
            .setRequest(
                Request.newBuilder()
                    ...
                    .setRequestId("req1")
                    .addInsertion(
                        Insertion.newBuilder().setContentId("content0").setRetrievalRank(0))
                    .addInsertion(
                        Insertion.newBuilder().setContentId("content1").setRetrievalRank(1))
                    .addInsertion(
                        Insertion.newBuilder().setContentId("content2").setRetrievalRank(2)))
            .build(),
        mockOut);
    verify(mockOut)
        .collect(
            ...
            .setRequest(
                Request.newBuilder()
                    ...
                    .setUserInfo(
                        UserInfo.newBuilder().setLogUserId("logUserId1").setUserId("userId1"))
                    .setRequestId("req1")
                    .addInsertion(Insertion.newBuilder().setContentId("content0"))
                    .addInsertion(Insertion.newBuilder().setContentId("content1"))
                    .addInsertion(Insertion.newBuilder().setContentId("content2")))
            .build(),
        mockOut);
    verify(mockOut)
        .collect(
