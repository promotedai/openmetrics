...
public class AvroPojoUtilsTest {
  ...
  public void testFromAvroRecordToMap() throws IOException {
    ...
    assertMapEquals(getExpectedRecordMap(timeMillis1), fromAvroRecordToMap(exactlyOne(actual)));
  }
  ...
  public void testAssertAvroFiles_fail() throws IOException {
    ...
    assertThrows(
        ...
        () -> {
          assertAvroFiles(ImmutableSet.of(getExpectedRecordMap(timeMillis2)), files);
        });
  }
